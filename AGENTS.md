...
Keep package.json, package-lock.json, both Cargo package versions, Cargo.lock, src-tauri/tauri.conf.json, and the Windows workflow artifact name synchronized for each release. Preserve the existing application identifier and saved data on upgrades.
